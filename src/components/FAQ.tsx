...
const FAQData: FAQItem[] = [
  {
    ...
    answer:
      "To pick up your disc, contact one of our volunteers via text to coordinate a time to retrieve it. A min of 12 hours lead-time is required. Do not just show up at the course and expect to get your disc back. You can reach out to Ali Bourgault @ 978-831-3784 to schedule a pickup window.",
  },
  {
